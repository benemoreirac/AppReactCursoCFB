...
export default function ElevaState(){
    ...
    return (
        <>
            <Nota num={1} nome={'nota1'} nota={notas.nota1} setNotas={handleSetNotas}/>
            <Nota num={2} nome={'nota2'} nota={notas.nota2} setNotas={handleSetNotas}/>
            <Nota num={3} nome={'nota3'} nota={notas.nota3} setNotas={handleSetNotas}/>
            <Nota num={4} nome={'nota4'} nota={notas.nota4} setNotas={handleSetNotas}/>
